...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemEight()
        {
            ...
            var shoppingCarts = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => sc.UserId == 2);
        ...
        private void ProblemNine()
        {
            ...
            var shoppingCarts = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => sc.UserId == 1).Select(sc => sc.Product.Price).Sum();
            { 
                Console.WriteLine($"Total Price: ${shoppingCarts}"); 
            }
        ...
        private void ProblemSixteen()
        {
            ...
            var item = _context.Products.Where(p => p.Name == "PS5").SingleOrDefault();
            item.Price = 499;
